...
class STB_all(MeanScaleHyperprior):
    # 基于JointAutoregressiveHierarchicalPriors更改的可变码率网络
    def __init__(self, N=192, M=192, **kwargs): # ll更改
        ...
        self.g_a_high_0 = conv(3, N, kernel_size=5, stride=2)
        self.g_a_high_1 = last_STB(dim=N,
        ...
        self.g_a_high_4 = conv(N, N, kernel_size=5, stride=2)
        self.g_a_high_5 = last_STB(dim=N,
                        input_resolution=(32,32),
                        depth=depths[2],
                        num_heads=num_heads[2],
                        window_size=window_size,
        ...
        self.g_s_high_0 = deconv(M, N, kernel_size=5, stride=2)
        self.g_s_high_1 = last_STB(dim=N,
                        input_resolution=(32,32),
                        depth=depths[2],
                        num_heads=num_heads[2],
                        window_size=window_size,
        ...
        self.g_s_high_4 = deconv(N, N, kernel_size=5, stride=2)
        self.g_s_high_5 = last_STB(dim=N,
                        input_resolution=(128,128),
                        depth=depths[4],
    ...
    def g_a_higher(self, x, x_size=None):
            ...
            x = self.g_a_high_0(x)
            x = self.g_a_high_1(x, (x_size[0]//2, x_size[1]//2))
            x = self.g_a_high_2(x)
            x = self.g_a_high_3(x, (x_size[0]//4, x_size[1]//4))
            x = self.g_a_high_4(x)
            x = self.g_a_high_5(x, (x_size[0]//8, x_size[1]//8))
            x = self.g_a_high_6(x)
            return x
    ...
    def g_s_higher(self, x, x_size=None):
            ...
            x = self.g_s_high_0(x)
            x = self.g_s_high_1(x, (x_size[0]//8, x_size[1]//8))
            x = self.g_s_high_2(x)
            x = self.g_s_high_3(x, (x_size[0]//4, x_size[1]//4))
            x = self.g_s_high_4(x)
            x = self.g_s_high_5(x, (x_size[0]//2, x_size[1]//2))
            x = self.g_s_high_6(x)
            return x
