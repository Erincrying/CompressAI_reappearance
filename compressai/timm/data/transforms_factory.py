...
from compressai.timm.data.constants import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD, DEFAULT_CROP_PCT
from compressai.timm.data.auto_augment import rand_augment_transform, augment_and_mix_transform, auto_augment_transform
from compressai.timm.data.transforms import str_to_interp_mode, str_to_pil_interp, RandomResizedCropAndInterpolation,\
    ResizeKeepRatio, CenterCropOrPad, RandomCropOrPad, TrimBorder, ToNumpy
from compressai.timm.data.random_erasing import RandomErasing
...
def create_transform(
    ...
    if tf_preprocessing and use_prefetcher:
        ...
        from compressai.timm.data.tf_preprocessing import TfPreprocessTransform
