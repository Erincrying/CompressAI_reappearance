...
from compressai.timm.layers import Conv2dSame, ScaledStdConv2dSame, CondConv2d, StdConv2dSame
from compressai.timm.layers.non_local_attn import BilinearAttnTransform
from compressai.timm.layers.pool2d_same import MaxPool2dSame, AvgPool2dSame
from compressai.timm.layers.norm_act import (
    BatchNormAct2d,
    SyncBatchNormAct,
...
# NOTE: By default, any modules from compressai.timm.models.layers that we want to treat as leaf modules go here
# BUT modules from compressai.timm.models should use the registration mechanism below
_leaf_modules = {
...
try:
    from compressai.timm.layers import InplaceAbn
