...
"""
Modifed from compressai.timm. https://github.com/rwightman/pytorch-image-models/blob/master/timm/models/vision_transformer.py
...
from compressai.timm.layers import DropPath, to_2tuple, trunc_normal_, _assert
